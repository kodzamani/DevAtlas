...
/// <summary>
/// Static constant array of all AI prompts from the Swift reference implementation.
/// </summary>
public static class AIPromptsConstants
{
    public static readonly AIPromptCategoryDefinition[] Categories =
    [
        // ────────────────────────────────────────
        // MARK: 1 · Kod Kalitesi (Code Quality)
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.codeQuality",
            IconName: "checkmark.shield",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.unusedCode.title",
                    DescriptionKey: "aiprompts.prompt.unusedCode.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.codeSmells.title",
                    DescriptionKey: "aiprompts.prompt.codeSmells.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.memoryLeaks.title",
                    DescriptionKey: "aiprompts.prompt.memoryLeaks.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.securityAudit.title",
                    DescriptionKey: "aiprompts.prompt.securityAudit.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.errorHandling.title",
                    DescriptionKey: "aiprompts.prompt.errorHandling.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        // MARK: 2 · Performans (Performance)
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.performance",
            IconName: "speedometer",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.bottleneck.title",
                    DescriptionKey: "aiprompts.prompt.bottleneck.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.swiftuiRender.title",
                    DescriptionKey: "aiprompts.prompt.swiftuiRender.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.appLaunch.title",
                    DescriptionKey: "aiprompts.prompt.appLaunch.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        // MARK: 3 · Mimari & Tasarım (Architecture)
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.architecture",
            IconName: "building.2",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.architectureDeep.title",
                    DescriptionKey: "aiprompts.prompt.architectureDeep.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.designPatterns.title",
                    DescriptionKey: "aiprompts.prompt.designPatterns.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.refactoringGuide.title",
                    DescriptionKey: "aiprompts.prompt.refactoringGuide.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.testing",
            IconName: "testtube.2",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.testCoverage.title",
                    DescriptionKey: "aiprompts.prompt.testCoverage.desc",
                    Prompt: """
                        You are a QA architect. Perform a comprehensive test gap analysis on my project.
                ...
                new(
                    TitleKey: "aiprompts.prompt.unitTestAudit.title",
                    DescriptionKey: "aiprompts.prompt.unitTestAudit.desc",
                    Prompt: """
                        You are a test-quality specialist. Audit all existing tests in my project for reliability and maintainability.

                        ## Test Quality Checks

                        ### Naming & Structure
                        - Do test names follow `test_[method]_when[Condition]_should[Behavior]` convention?
                        ...
                        - Do tests rely on real file system, network, database, or time?
                        ...
                        - Are there real objects used where mocks should be?
                ...
                new(
                    TitleKey: "aiprompts.prompt.testGenerator.title",
                    DescriptionKey: "aiprompts.prompt.testGenerator.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.documentation",
            IconName: "doc.text",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.apiDocs.title",
                    DescriptionKey: "aiprompts.prompt.apiDocs.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.readmeDocs.title",
                    DescriptionKey: "aiprompts.prompt.readmeDocs.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.commentsAudit.title",
                    DescriptionKey: "aiprompts.prompt.commentsAudit.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.debugging",
            IconName: "ant",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.crashBugAudit.title",
                    DescriptionKey: "aiprompts.prompt.crashBugAudit.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.instrumentsGuide.title",
                    DescriptionKey: "aiprompts.prompt.instrumentsGuide.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.networking",
            IconName: "network",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.networkAudit.title",
                    DescriptionKey: "aiprompts.prompt.networkAudit.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.apiMock.title",
                    DescriptionKey: "aiprompts.prompt.apiMock.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.accessibility",
            IconName: "accessibility",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.a11yAudit.title",
                    DescriptionKey: "aiprompts.prompt.a11yAudit.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.localization",
            IconName: "globe",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.i18nAudit.title",
                    DescriptionKey: "aiprompts.prompt.i18nAudit.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.cicd",
            IconName: "arrow.triangle.branch",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.gitWorkflow.title",
                    DescriptionKey: "aiprompts.prompt.gitWorkflow.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.cicdPipeline.title",
                    DescriptionKey: "aiprompts.prompt.cicdPipeline.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.dependencies",
            IconName: "shippingbox",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.depAudit.title",
                    DescriptionKey: "aiprompts.prompt.depAudit.desc",
                    Prompt: """
        ...
        // ────────────────────────────────────────
        new(
            TitleKey: "aiprompts.category.codeGeneration",
            IconName: "wand.and.stars",
            Prompts:
            [
                new(
                    TitleKey: "aiprompts.prompt.crudGen.title",
                    DescriptionKey: "aiprompts.prompt.crudGen.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.boilerplateGen.title",
                    DescriptionKey: "aiprompts.prompt.boilerplateGen.desc",
                    Prompt: """
                ...
                new(
                    TitleKey: "aiprompts.prompt.projectReport.title",
                    DescriptionKey: "aiprompts.prompt.projectReport.desc",
                    Prompt: """
